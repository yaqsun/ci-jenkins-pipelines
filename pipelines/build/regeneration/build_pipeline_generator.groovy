...
node('worker') {
    try {
        ...
        Map<String, ?> ADOPT_DEFAULTS_JSON = new JsonSlurper().parseText(JsonOutput.prettyPrint(JsonOutput.toJson(TEST_CONF))) as Map
        //Map<String, ?> ADOPT_DEFAULTS_JSON = JsonOutput.prettyPrint(JsonOutput.toJson(TEST_CONF))
        //println ADOPT_DEFAULTS_JSON

        //def ADOPT_DEFAULTS_JSON = readJSON file: "${WORKSPACE}/ci-jenkins-pipelines/master/pipelines/defaults.json"
        //getAdopt = null
        //println getAdopt
        ...
        Map<String, ?> DEFAULTS_JSON = new JsonSlurper().parseText(JsonOutput.prettyPrint(JsonOutput.toJson(TEST_CONF))) as Map
...
//            ])
        ...
        timestamps {
            ...
            println "remoteConfigs === " + remoteConfigs
            if (checkoutCreds != '') {
